...
public class OkHttpBuilder {
     ...
     * 读超时 秒
     */
    private final static long DEFAULT_READ_TIMEOUT = 3 * 60;
    /**
     * 写超时 秒
     */
    private final static long DEFAULT_WRITE_TIMEOUT = 3 * 60;
    /**
     * 连接超时 秒
     */
    private final static long DEFAULT_CONNECT_TIMEOUT = 3 * 60;
    /**
     * 长连接时间 分钟
     */
